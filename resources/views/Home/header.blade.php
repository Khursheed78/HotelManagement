                    ...
                    <nav class="navigation navbar navbar-expand-md navbar-dark">
                        ...
                        <div class="collapse navbar-collapse" id="navbarsExample04">
                            <ul class="navbar-nav mr-auto">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="{{route('home.abouts')}}">About</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="{{route('home.ourroom')}}">Our Room</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="{{route('home.ourgallery')}}">Gallery</a>
                                </li>
                                {{-- <li class="nav-item">
